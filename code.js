...
(() => {
  ...
  // widget-src/code.tsx
  var { widget } = figma;
  var { useSyncedState, usePropertyMenu, AutoLayout, Input, Text, SVG, Rectangle, Frame } = widget;
  function generateId() {
    return `${Date.now()}-${Math.random().toString(36).substr(2, 9)}`;
  }
  var bulletIcon = `<svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<path d="M6.42857 13.543H18.4286" stroke="white" stroke-width="1.2" stroke-linecap="round" stroke-linejoin="round"/>
  ...
  var numberedIcon = `<svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<path d="M5.88614 13.5H18.7433" stroke="white" stroke-width="1.2" stroke-linecap="round" stroke-linejoin="round"/>
  ...
  var expandIcon = `<svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<path d="M5.7999 5.43359L2.10701 9.12649C1.71649 9.51701 1.71649 10.1502 2.10701 10.5407L5.7999 14.2336" stroke="white" stroke-width="1.2" stroke-linecap="round" stroke-linejoin="round"/>
  ...
  var shrinkIcon = `<svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<path d="M1.8002 5.43359L5.49309 9.12649C5.88361 9.51701 5.88361 10.1502 5.49309 10.5407L1.8002 14.2336" stroke="white" stroke-width="1.2" stroke-linecap="round" stroke-linejoin="round"/>
  ...
  var lightThemeIcon = `<svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<rect width="100%" height="100%" fill="white"/>
  ...
  var darkThemeIcon = `<svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M10 17.5C7.91667 17.5 6.14583 16.7708 4.6875 15.3125C3.22917 13.8542 2.5 12.0833 2.5 10C2.5 7.91667 3.22917 6.14583 4.6875 4.6875C6.14583 3.22917 7.91667 2.5 10 2.5C10.1944 2.5 10.3856 2.50694 10.5733 2.52083C10.7611 2.53472 10.945 2.55556 11.125 2.58333C10.5556 2.98611 10.1006 3.51056 9.76 4.15667C9.41944 4.80278 9.24944 5.50056 9.25 6.25C9.25 7.5 9.6875 8.5625 10.5625 9.4375C11.4375 10.3125 12.5 10.75 13.75 10.75C14.5139 10.75 15.2153 10.5797 15.8542 10.2392C16.4931 9.89861 17.0139 9.44389 17.4167 8.875C17.4444 9.05555 17.4653 9.23944 17.4792 9.42667C17.4931 9.61389 17.5 9.805 17.5 10C17.5 12.0833 16.7708 13.8542 15.3125 15.3125C13.8542 16.7708 12.0833 17.5 10 17.5ZM10 15.8333C11.2222 15.8333 12.3194 15.4964 13.2917 14.8225C14.2639 14.1486 14.9722 13.2703 15.4167 12.1875C15.1389 12.2569 14.8611 12.3125 14.5833 12.3542C14.3056 12.3958 14.0278 12.4167 13.75 12.4167C12.0417 12.4167 10.5867 11.8158 9.385 10.6142C8.18333 9.4125 7.58278 7.95778 7.58333 6.25C7.58333 5.97222 7.60417 5.69444 7.64583 5.41667C7.6875 5.13889 7.74306 4.86111 7.8125 4.58333C6.72917 5.02778 5.85056 5.73611 5.17667 6.70833C4.50278 7.68056 4.16611 8.77778 4.16667 10C4.16667 11.6111 4.73611 12.9861 5.875 14.125C7.01389 15.2639 8.38889 15.8333 10 15.8333Z" fill="white"/>
  ...
  function StickyProWidget() {
    var _a;
    const [mainHeading, setMainHeading] = useSyncedState("mainHeading", "");
    const [blocks, setBlocks] = useSyncedState("blocks", [
      {
        id: "initial-block",
        type: "text",
        content: "",
    ...
    const [width, setWidth] = useSyncedState("width", 360);
    const [focusedBlockId, setFocusedBlockId] = useSyncedState("focusedBlockId", "initial-block");
    const [focusedLineId, setFocusedLineId] = useSyncedState("focusedLineId", null);
    const [showAddBlockToolbar, setShowAddBlockToolbar] = useSyncedState("showAddBlockToolbar", false);
    const [showFormatDropdown, setShowFormatDropdown] = useSyncedState("showFormatDropdown", false);
    const [theme, setTheme] = useSyncedState("theme", "dark");
    const focusedBlock = blocks.find((b) => b.id === focusedBlockId);
    const focusedLine = (_a = focusedBlock == null ? void 0 : focusedBlock.lines) == null ? void 0 : _a.find((l) => l.id === focusedLineId);
    usePropertyMenu(
      [
        // Text format buttons (only for text blocks)
        ...(focusedBlock == null ? void 0 : focusedBlock.type) === "text" ? [
          {
            itemType: "action",
            tooltip: "H1",
          ...
          },
          {
            ...
            isToggled: ((focusedBlock == null ? void 0 : focusedBlock.listType) || "none") === "bullet",
            icon: bulletIcon
          },
          {
            itemType: "toggle",
            ...
            isToggled: ((focusedBlock == null ? void 0 : focusedBlock.listType) || "none") === "numbered",
            icon: numberedIcon
          },
          {
            itemType: "separator"
      ...
      ({ propertyName }) => {
        ...
        if (propertyName === "format-h1" || propertyName === "format-b1" || propertyName === "format-c1") {
          const format = propertyName.split("-")[1].toUpperCase();
          if (focusedLineId) {
    ...
    const addBlock = (type) => {
      ...
      const newBlock = __spreadValues(__spreadValues({
        id: blockId,
        type,
        content: ""
      }, type === "text" && {
    ...
    const addLineToBlock = (blockId, afterLineId) => {
      setBlocks(
        blocks.map((b) => {
          var _a2;
          if (b.id === blockId && b.type === "text") {
            ...
            const newLine = {
              id: generateId(),
              text: "",
              format: ((_a2 = lines[lines.length - 1]) == null ? void 0 : _a2.format) || "B1"
            };
            if (afterLineId) {
              ...
              return __spreadProps(__spreadValues({}, b), { lines: newLines });
            }
            return __spreadProps(__spreadValues({}, b), { lines: [...lines, newLine] });
          }
          return b;
        })
      );
    };
    const updateLineInBlock = (blockId, lineId, text) => {
      setBlocks(
        blocks.map((b) => {
          if (b.id === blockId && b.type === "text") {
            const lines = b.lines || [];
            return __spreadProps(__spreadValues({}, b), {
              lines: lines.map((l) => l.id === lineId ? __spreadProps(__spreadValues({}, l), { text }) : l)
            });
          }
          return b;
        })
    ...
    const updateLineFormat = (blockId, lineId, format) => {
      setBlocks(
        blocks.map((b) => {
          if (b.id !== blockId || b.type !== "text") return b;
          return __spreadProps(__spreadValues({}, b), {
            lines: (b.lines || []).map((l) => l.id === lineId ? __spreadProps(__spreadValues({}, l), { format }) : l)
          });
        })
      );
    };
    const deleteLineFromBlock = (blockId, lineId) => {
      setBlocks(
        blocks.map((b) => {
          if (b.id !== blockId || b.type !== "text") return b;
    ...
    const updateBlockContent = (blockId, content) => {
      setBlocks(blocks.map((b) => b.id === blockId ? __spreadProps(__spreadValues({}, b), { content }) : b));
    };
    const updateBlockFormat = (blockId, format) => {
      setBlocks(blocks.map((b) => b.id === blockId ? __spreadProps(__spreadValues({}, b), { format }) : b));
      setShowFormatDropdown(false);
    };
    const updateBlockListType = (blockId, listType) => {
      setBlocks(blocks.map((b) => b.id === blockId ? __spreadProps(__spreadValues({}, b), { listType }) : b));
    };
    const toggleWidth = () => {
      setWidth(width === 360 ? 480 : 360);
    };
    const addTodoItem = (blockId) => {
      setBlocks(
        blocks.map((b) => {
          ...
          return __spreadProps(__spreadValues({}, b), { todos: [...b.todos || [], newTodo] });
        })
      );
    };
    const updateTodoItem = (blockId, todoId, text) => {
      setBlocks(
        blocks.map((b) => {
          if (b.id !== blockId || b.type !== "todo") return b;
          return __spreadProps(__spreadValues({}, b), {
            todos: (b.todos || []).map((t) => t.id === todoId ? __spreadProps(__spreadValues({}, t), { text }) : t)
          });
        })
      );
    };
    const toggleTodoCompletion = (blockId, todoId) => {
      setBlocks(
        blocks.map((b) => {
          if (b.id !== blockId || b.type !== "todo") return b;
          return __spreadProps(__spreadValues({}, b), {
            todos: (b.todos || []).map((t) => t.id === todoId ? __spreadProps(__spreadValues({}, t), { completed: !t.completed }) : t)
          });
        })
      );
    };
    ...
    const insertTodoAfter = (blockId, todoId) => {
      setBlocks(
        blocks.map((b) => {
          if (b.id !== blockId || b.type !== "todo") return b;
          const todos = b.todos || [];
    ...
    return /* @__PURE__ */ figma.widget.h(
      ...
      /* @__PURE__ */ figma.widget.h(
        ...
        blocks.map((block, index) => /* @__PURE__ */ figma.widget.h(
          BlockComponent,
          {
            key: block.id,
            block,
      ...
      showAddBlockToolbar && /* @__PURE__ */ figma.widget.h(
        AutoLayout,
        {
          direction: "horizontal",
          width: "hug-contents",
        ...
        /* @__PURE__ */ figma.widget.h(AddBlockMenu, { onAddText: () => addBlock("text"), onAddTodo: () => addBlock("todo") })
      )
    );
  }
  function MainHeading({ value, onChange, width, theme, onFocus }) {
    const colors = themeColors[theme];
    return /* @__PURE__ */ figma.widget.h(
      AutoLayout,
      {
  ...
  function TextBlock({
    ...
    return /* @__PURE__ */ figma.widget.h(
      ...
      /* @__PURE__ */ figma.widget.h(
        ...
        isFocused && /* @__PURE__ */ figma.widget.h(CloseButton, { onClick: onDelete }),
        /* @__PURE__ */ figma.widget.h(
          AutoLayout,
          {
            direction: "vertical",
          ...
          lines.map((line, index) => {
            ...
            return /* @__PURE__ */ figma.widget.h(
              ...
              listType !== "none" && /* @__PURE__ */ figma.widget.h(
                Text,
                {
                  fontSize,
                  fontFamily: "Inter",
              ...
              /* @__PURE__ */ figma.widget.h(
                ...
                !line.text && /* @__PURE__ */ figma.widget.h(
                  AutoLayout,
                  {
                    positioning: "absolute",
                    direction: "horizontal",
                  ...
                  index === 0 && /* @__PURE__ */ figma.widget.h(
                    SVG,
                    {
...
<path d="M11.2332 2.35209C11.4083 2.17699 11.6162 2.0381 11.845 1.94334C12.0737 1.84858 12.3189 1.7998 12.5666 1.7998C12.8142 1.7998 13.0594 1.84858 13.2881 1.94334C13.5169 2.0381 13.7248 2.17699 13.8999 2.35209C14.075 2.52719 14.2139 2.73505 14.3086 2.96383C14.4034 3.1926 14.4522 3.4378 14.4522 3.68542C14.4522 3.93305 14.4034 4.17824 14.3086 4.40702C14.2139 4.63579 14.075 4.84366 13.8999 5.01876L6.06657 12.8521L2.3999 13.8521L3.3999 10.1854L11.2332 2.35209Z" stroke="${colors.editIcon}" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"/>
          ...
          onAddLine && lines.length > 0 && lines[lines.length - 1].text.length > 0 && /* @__PURE__ */ figma.widget.h(
            AutoLayout,
            {
              direction: "horizontal",
              spacing: 4,
...
<path d="M5.42857 6.57143H2.57143C2.40953 6.57143 2.27391 6.51657 2.16457 6.40686C2.05524 6.29714 2.00038 6.16153 2 6C1.99962 5.83848 2.05448 5.70286 2.16457 5.59314C2.27467 5.48343 2.41029 5.42857 2.57143 5.42857H5.42857V2.57143C5.42857 2.40953 5.48343 2.27391 5.59314 2.16457C5.70286 2.05524 5.83848 2.00038 6 2C6.16153 1.99962 6.29734 2.05448 6.40743 2.16457C6.51753 2.27467 6.57219 2.41029 6.57143 2.57143V5.42857H9.42857C9.59048 5.42857 9.72629 5.48343 9.836 5.59314C9.94572 5.70286 10.0004 5.83848 10 6C9.99962 6.16153 9.94476 6.29734 9.83543 6.40743C9.7261 6.51753 9.59048 6.57219 9.42857 6.57143H6.57143V9.42857C6.57143 9.59048 6.51657 9.72629 6.40686 9.836C6.29714 9.94572 6.16153 10.0004 6 10C5.83848 9.99962 5.70286 9.94476 5.59314 9.83543C5.48343 9.7261 5.42857 9.59048 5.42857 9.42857V6.57143Z" fill="${colors.addButtonText}"/>
            ...
            /* @__PURE__ */ figma.widget.h(Text, { fontSize: 10, lineHeight: 8, fontFamily: "Inter", fontWeight: 400, fill: colors.addButtonText }, block.listType && block.listType !== "none" ? "Next list" : "Add")
          )
        )
      )
    );
  ...
  function TodoBlock({
    ...
    return /* @__PURE__ */ figma.widget.h(
      ...
      /* @__PURE__ */ figma.widget.h(
        ...
        (isFocused || todos.length > 0 && todos[todos.length - 1].text.length > 0) && /* @__PURE__ */ figma.widget.h(
          AutoLayout,
          {
            direction: "horizontal",
            spacing: 4,
...
<path d="M5.42857 6.57143H2.57143C2.40953 6.57143 2.27391 6.51657 2.16457 6.40686C2.05524 6.29714 2.00038 6.16153 2 6C1.99962 5.83848 2.05448 5.70286 2.16457 5.59314C2.27467 5.48343 2.41029 5.42857 2.57143 5.42857H5.42857V2.57143C5.42857 2.40953 5.48343 2.27391 5.59314 2.16457C5.70286 2.05524 5.83848 2.00038 6 2C6.16153 1.99962 6.29734 2.05448 6.40743 2.16457C6.51753 2.27467 6.57219 2.41029 6.57143 2.57143V5.42857H9.42857C9.59048 5.42857 9.72629 5.48343 9.836 5.59314C9.94572 5.70286 10.0004 5.83848 10 6C9.99962 6.16153 9.94476 6.29734 9.83543 6.40743C9.7261 6.51753 9.59048 6.57219 9.42857 6.57143H6.57143V9.42857C6.57143 9.59048 6.51657 9.72629 6.40686 9.836C6.29714 9.94572 6.16153 10.0004 6 10C5.83848 9.99962 5.70286 9.94476 5.59314 9.83543C5.48343 9.7261 5.42857 9.59048 5.42857 9.42857V6.57143Z" fill="${colors.addButtonText}"/>
          ...
          /* @__PURE__ */ figma.widget.h(Text, { fontSize: 10, lineHeight: 12, fontFamily: "Inter", fontWeight: 400, fill: colors.addButtonText }, "Add list")
        )
      )
    );
  }
  function TodoItem({
    ...
    return /* @__PURE__ */ figma.widget.h(
      ...
      /* @__PURE__ */ figma.widget.h(
        ...
        todo.completed && /* @__PURE__ */ figma.widget.h(
          SVG,
          {
...
<path d="M10 3L4.5 8.5L2 6" stroke="black" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"/>
  ...
  function AddBlockMenu({ onAddText, onAddTodo }) {
    return /* @__PURE__ */ figma.widget.h(
      AutoLayout,
      {
        name: "AddBlock",
